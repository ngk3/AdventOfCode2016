...
public class Star47 {	
	...
	public void getPermutations(String number_start, ArrayList<String> numbers_add, HashMap<String, Integer> number_perm) {
		...
		if (numbers_add.size() == 0)
			number_perm.put(number_start, 0);
		else {
	...
	public static void main(String[] argvs) {
		Star47 pgm = new Star47();
		System.out.println("Fewest steps to visit every number starting at 0 = " + pgm.getFewestSteps("Star47_input.txt"));
	}
}
